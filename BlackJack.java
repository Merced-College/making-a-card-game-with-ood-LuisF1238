...
System.out.println("You have $" + Cash +", how much would you like to betting this round?" );

 Bet = scanner.nextInt();
System.out.println("This round you will be betting " + Bet + "?");
String confirm = scanner.next();

if (confirm.equals("yes")){

    System.out.println("You will now be playing with " + Bet);
} else scanner.close();
...
//asks player if they want to play again
            ...
            System.out.println("You have $" +Cash+ ". Would you like to play another hand?");
...
//System.out.println("Your cards: " + RANKS[card1] + " of " + SUITS[card1 / 13]
  //          + " and " + RANKS[card2] + " of " + SUITS[card2 / 13]);
            System.out.println("Your cards: " + card1.getRank() + " of " + card1.getSuit()
                    + " and " + card2.getRank() + " of " + card2.getSuit());
...
//resets playerTotal so the game can be played multiple times
        ...
        private static void determineWinner(int playerTotal, int dealerTotal) {
            if (dealerTotal > 21 || playerTotal > dealerTotal) {
                Cash = Cash + Bet;
                System.out.println("You win! " + "You have $"+ Cash);
            } else if (dealerTotal == playerTotal) {
                System.out.println("It's a tie!");
            } else {
                Cash = Cash - Bet;
                System.out.println("Dealer wins!" + "You have $"+ Cash);
                playerTotal = 0;
